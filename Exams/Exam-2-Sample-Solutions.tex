...
\[
\underline{\False}\qquad\frac{1}{2}~<~\Prob{\RandVar{X} \;<\; \RandVar{Y}} = \sum_{i=1}^{3} \sum_{j=i+1}^{3} \PMF{X,Y}{j,\,i} = \frac{2}{68} + \frac{1}{68} + \frac{2}{68} = \frac{5}{68} \approx 0.07353
\]
\vfill
